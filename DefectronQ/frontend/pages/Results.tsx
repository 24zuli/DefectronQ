...
const Results = () => {
  ...
  useEffect(() => {
    ...
    ctx.lineTo(padding + rocPoints[rocPoints.length - 1].x * width, canvas.height - padding);
    ...
    ctx.textAlign = 'center';
    ctx.fillText('AUC = 0.927', canvas.width / 2, padding + 30);
  }, []);
    ...
    for (let i = 0; i < 2; i++) {
      for (let j = 0; j < 2; j++) {
        ...
        if (i === j) {
          ...
          ctx.fillStyle = `rgba(59, 130, 246, ${Math.min(0.2 + colorIntensity * 0.8, 1)})`;
        } else {
          // Off-diagonal (FP, FN) - red gradient
          colorIntensity = matrix[i][j] / 100;
          ctx.fillStyle = `rgba(239, 68, 68, ${Math.min(0.2 + colorIntensity * 0.8, 1)})`;
        }
          ...
          <div className="mt-10 bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl border border-gray-700">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
              <div className="bg-gray-900 p-4 rounded-lg text-center">
                ...
                <p className="text-3xl font-bold text-blue-400">94.0%</p>
              </div>
              
              <div className="bg-gray-900 p-4 rounded-lg text-center">
                <h4 className="text-lg font-semibold mb-1">Precision</h4>
                <p className="text-3xl font-bold text-purple-400">89.3%</p>
              </div>
              
              <div className="bg-gray-900 p-4 rounded-lg text-center">
                <h4 className="text-lg font-semibold mb-1">Recall</h4>
                <p className="text-3xl font-bold text-pink-400">92.0%</p>
              </div>
              
              <div className="bg-gray-900 p-4 rounded-lg text-center">
                <h4 className="text-lg font-semibold mb-1">F1 Score</h4>
                <p className="text-3xl font-bold text-green-400">90.6%</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
              <Card3D className="p-6">
                ...
                <p className="text-gray-400 mb-6">
                  The Receiver Operating Characteristic curve shows the tradeoff between 
              ...
              <Card3D className="p-6" glowColor="rgba(168, 85, 247, 0.4)">
                <h3 className="text-xl font-semibold mb-4">Precision-Recall Curve</h3>
                <p className="text-gray-400 mb-6">
                  This curve shows the tradeoff between precision and recall, which is 
                  especially important for imbalanced datasets like anomaly detection.
                </p>
                <div className="aspect-square w-full bg-gray-800 rounded-lg overflow-hidden">
                  <canvas ref={precisionRecallRef} className="w-full h-full"></canvas>
                </div>
              </Card3D>
              ...
              <Card3D className="p-6" glowColor="rgba(236, 72, 153, 0.4)">
                ...
                <p className="text-gray-400 mb-6">
                  The confusion matrix provides a detailed breakdown of correct and 
                  incorrect classifications across both normal and anomalous samples.
                </p>
                <div className="aspect-square w-full bg-gray-800 rounded-lg overflow-hidden">
                  <canvas ref={confusionMatrixRef} className="w-full h-full"></canvas>
                </div>
              </Card3D>
            </div>
          </div>
      ...
      <section className="py-20 bg-gray-900 border-t border-gray-800">
        <div className="container mx-auto px-4">
            ...
            {[1, 2, 3].map((index) => (
              <Card3D key={index} className="overflow-hidden">
                <div className="grid grid-cols-2 gap-2 p-4">
                  <div>
                    <h4 className="text-center text-sm font-semibold mb-2">Original</h4>
                  ...
                  <div>
                    <h4 className="text-center text-sm font-semibold mb-2">Reconstruction</h4>
                    <div className="aspect-square bg-gray-800 rounded-lg overflow-hidden relative">
                      <img 
                        src={`https://images.pexels.com/photos/1484516/pexels-photo-1484516.jpeg?auto=compress&cs=tinysrgb&w=600`} 
                  ...
                  <div className="col-span-2">
                    <h4 className="text-center text-sm font-semibold mb-2">Anomaly Map</h4>
                    <div className="aspect-video bg-gray-800 rounded-lg overflow-hidden relative">
                      ...
                      <div className="absolute bottom-2 right-2 bg-gray-900/80 rounded-md px-2 py-1 text-xs">
                        Score: <span className="text-red-400 font-semibold">0.87</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="mt-16 bg-gray-800 rounded-xl p-6 md:p-10">
            <h3 className="text-2xl font-semibold mb-6">Comparative Analysis</h3>
            <div className="overflow-x-auto">
              <table className="w-full border-collapse">
                <thead>
                  <tr className="border-b border-gray-700">
                    <th className="py-3 px-4 text-left text-sm font-semibold text-gray-300">Model</th>
                    <th className="py-3 px-4 text-center text-sm font-semibold text-gray-300">Accuracy</th>
                    <th className="py-3 px-4 text-center text-sm font-semibold text-gray-300">Precision</th>
                    <th className="py-3 px-4 text-center text-sm font-semibold text-gray-300">Recall</th>
                    <th className="py-3 px-4 text-center text-sm font-semibold text-gray-300">F1 Score</th>
                    <th className="py-3 px-4 text-center text-sm font-semibold text-gray-300">AUC</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b border-gray-700 bg-blue-500/10">
                    <td className="py-3 px-4 font-semibold">Quantum-Enhanced (Ours)</td>
                    <td className="py-3 px-4 text-center">94.0%</td>
                    <td className="py-3 px-4 text-center">89.3%</td>
                    <td className="py-3 px-4 text-center">92.0%</td>
                    <td className="py-3 px-4 text-center">90.6%</td>
                    <td className="py-3 px-4 text-center">92.7%</td>
                  </tr>
                  <tr className="border-b border-gray-700">
