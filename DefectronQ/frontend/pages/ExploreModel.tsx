      ...
      <section className="hero-gradient min-h-[50vh] flex items-center">
        <div className="container mx-auto px-4 py-20">
          <SectionTitle 
            ...
            subtitle="Discover how our hybrid quantum-classical architecture learns to detect anomalies without ever seeing defective examples."
          />
          ...
          <div className="mt-10 bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl border border-gray-700">
            ...
            <p className="text-gray-300">
              Our approach uses a hybrid quantum-classical architecture for unsupervised anomaly detection. 
              The model learns to reconstruct normal bottle images during training. 
              At inference time, it struggles to reconstruct anomalous regions, 
              which helps identify defects by measuring the reconstruction error.
            </p>
          </div>
        </div>
      </section>
              ...
              <div className="flex items-center justify-between flex-wrap md:flex-nowrap gap-4 py-8">
                <div className="workflow-item p-4 bg-gray-800 rounded-lg w-full md:w-1/5">
                  <div className="text-center">
                    ...
                    <p className="text-gray-400 text-sm mt-2">Bottle image to be inspected</p>
                  </div>
                </div>
                ...
                <div className="workflow-item p-4 bg-gray-800 rounded-lg w-full md:w-1/5">
                  <div className="text-center">
                    ...
                    <p className="text-gray-400 text-sm mt-2">Compresses image into latent vector</p>
                  </div>
                </div>
                ...
                <div className="workflow-item p-4 bg-gray-800 rounded-lg w-full md:w-1/5">
                  <div className="text-center">
                    ...
                    <p className="text-gray-400 text-sm mt-2">Difference between original and reconstruction</p>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-12">
              <Card3D className="p-6">
                ...
                <ul className="space-y-2 text-gray-400">
                  ...
                  <li className="flex items-start">
                    <span className="text-blue-400 mr-2">•</span>
                    <span>Improved sensitivity to subtle patterns traditional models might miss</span>
                  </li>
                </ul>
                <div className="mt-6">
              ...
              <div className="space-y-6">
                <Card3D className="p-6" glowColor="rgba(139, 92, 246, 0.4)">
                  ...
                  <p className="text-gray-400 mt-4">
                    During training, the model is only exposed to normal bottles, learning to perfectly 
                    reconstruct their features. When a defective bottle is processed, the model struggles 
                    to reconstruct the anomalous regions, resulting in a high error that signals a defect.
                  </p>
                </Card3D>
