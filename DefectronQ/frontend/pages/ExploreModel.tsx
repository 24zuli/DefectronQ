      ...
      <section className="hero-gradient min-h-[50vh] flex items-center">
        <div className="container mx-auto px-4 py-20">
          ...
          <div className="mt-10 bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl border border-gray-700">
            ...
            Our approach leverages a hybrid quantum-classical autoencoder architecture designed for unsupervised anomaly detection.
            The model is trained exclusively on normal images, learning how to accurately reconstruct typical patterns and structures.</p>
            <p className="text-gray-300">
            During inference, when the model encounters anomalous inputs—patterns it has not learned—it fails to reconstruct these regions effectively.
This reconstruction failure produces higher reconstruction error, which we use as an anomaly score to reliably flag defective or abnormal samples.
            </p>
            <p className="text-gray-300">
By combining classical convolutional feature extraction with a quantum-enhanced decoder, the model achieves rich, expressive transformations in the latent space, improving its ability to detect subtle and complex anomalies.
            </p>
          </div>
        </div>
      </section>
    ...
    <div className="container mx-auto px-4">
        ...
        <div className="flex items-center justify-between flex-wrap md:flex-nowrap gap-4 py-8">
          <div className="workflow-item p-4 bg-gray-800 rounded-lg w-full md:w-1/5">
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm mt-2">Image to be inspected for anomalies</p>
            </div>
          </div>
          ...
          <div className="workflow-item p-4 bg-gray-800 rounded-lg w-full md:w-1/5">
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm mt-2">Compresses the image into a latent vector</p>
            </div>
          </div>
          ...
          <div className="workflow-item p-4 bg-gray-800 rounded-lg w-full md:w-1/5">
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm mt-2">Processes latent space through quantum circuits</p>
            </div>
          </div>
          ...
          <div className="workflow-item p-4 bg-gray-800 rounded-lg w-full md:w-1/5">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold">Reconstructed Image</h3>
              <p className="text-gray-400 text-sm mt-2">Generated prediction of normal appearance</p>
            </div>
          </div>
          ...
          <div className="workflow-item p-4 bg-gray-800 rounded-lg w-full md:w-1/5">
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm mt-2">Difference between the original and reconstructed image</p>
            </div>
          </div>
        </div>
      ...
      <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-12">
        <Card3D className="p-6">
          <h3 className="text-xl font-semibold mb-4">The Quantum Advantage</h3>
          <p className="text-gray-400 mb-4">
            Our model leverages quantum computing's unique capabilities to enhance anomaly detection:
          </p>
          <ul className="space-y-2 text-gray-400">
            <li className="flex items-start">
              <span className="text-blue-400 mr-2">•</span>
              <span>Superposition and entanglement enable complex feature interactions</span>
            </li>
            <li className="flex items-start">
              <span className="text-blue-400 mr-2">•</span>
              <span>Quantum circuits process high-dimensional data more efficiently</span>
            </li>
            <li className="flex items-start">
              <span className="text-blue-400 mr-2">•</span>
              <span>Improved sensitivity to subtle patterns that traditional models might miss</span>
            </li>
          </ul>
          <div className="mt-6">
            <h4 className="font-semibold mb-2">Quantum Circuit Architecture</h4>
        ...
        <div className="space-y-6">
          <Card3D className="p-6" glowColor="rgba(139, 92, 246, 0.4)">
            <h3 className="text-xl font-semibold mb-4">Optimization Objective</h3>
            <p className="text-gray-400">
              The model is trained to minimize reconstruction error on normal images:
            </p>
            ...
            <p className="text-gray-400 mt-4">
              During training, the model is only exposed to normal samples, learning to perfectly 
              reconstruct their features. When an anomalous input is processed, the model struggles 
              to reconstruct the abnormal regions, resulting in a high error that signals a defect.
            </p>
          </Card3D>
          
          <Card3D className="p-6" glowColor="rgba(236, 72, 153, 0.4)">
            <h3 className="text-xl font-semibold mb-4">Why Reconstruction Helps</h3>
            <p className="text-gray-400 mb-4">
              Reconstruction-based anomaly detection offers significant advantages:
            </p>
            <ul className="space-y-2 text-gray-400">
              <li className="flex items-start">
                <span className="text-pink-400 mr-2">•</span>
                <span>No defective examples needed for training (unsupervised learning)</span>
              </li>
              <li className="flex items-start">
                <span className="text-pink-400 mr-2">•</span>
                <span>Localizes defects by highlighting areas with high reconstruction error</span>
              </li>
              <li className="flex items-start">
                <span className="text-pink-400 mr-2">•</span>
                <span>Can detect novel defect types never seen during development</span>
              </li>
            </ul>
          </Card3D>
        </div>
