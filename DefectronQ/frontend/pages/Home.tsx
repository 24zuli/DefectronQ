...
const Home = () => {
  return (
    <div className="pt-1">
      {/* Hero section */}
      <section className="hero-gradient min-h-[50vh] flex items-center justify-center">
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center justify-center">
            ...
            <div className="lg:w-1/2 transform translate-y-10 opacity-0 animate-[fadeInUp_1s_0.5s_forwards]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
              <Card3D className="p-6 h-full">
                <div className="flex flex-col h-full">
                  <div className="rounded-full w-14 h-14 flex items-center justify-center bg-blue-500/20 mb-6">
                    <Flask className="text-blue-400" size={24} />
                  </div>
                  <h3 className="text-xl font-semibold mb-3">Data Imbalance</h3>
                  <p className="text-gray-400 flex-grow">
                    Normal products vastly outnumber defective ones.
                  </p>
                </div>
              </Card3D>
              
              <Card3D className="p-6 h-full" glowColor="rgba(139, 92, 246, 0.4)">
                <div className="flex flex-col h-full">
                  <div className="rounded-full w-14 h-14 flex items-center justify-center bg-purple-500/20 mb-6">
                    <Zap className="text-purple-400" size={24} />
                  </div>
                  <h3 className="text-xl font-semibold mb-3">High Stakes</h3>
                  <p className="text-gray-400 flex-grow">
                    False results lead to customer issues or wasted products.
                  </p>
                </div>
              </Card3D>
              
              <Card3D className="p-6 h-full" glowColor="rgba(236, 72, 153, 0.4)">
                <div className="flex flex-col h-full">
                  <div className="rounded-full w-14 h-14 flex items-center justify-center bg-pink-500/20 mb-6">
                    <Database className="text-pink-400" size={24} />
                  </div>
                  <h3 className="text-xl font-semibold mb-3">Complex Defects</h3>
                  <p className="text-gray-400 flex-grow">
                    Defects vary in appearance and location.
                  </p>
                </div>
              </Card3D>
            </div>
              ...
              <div className="flex flex-col md:flex-row gap-8">
                <div className="md:w-1/2">
                  ...
                  <p className="text-gray-400 mb-4">
                    Quantum-enhanced anomaly detection learns normal patterns.
                  </p>
